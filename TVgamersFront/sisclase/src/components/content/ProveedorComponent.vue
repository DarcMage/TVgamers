			...
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel" id="tabladatosmenus" v-show="!mostrarformulario">
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
						<tr v-for="itemProveedor in listaProveedor" v-bind:key="itemProveedor" v-bind:itemProveedor="itemProveedor" >
					...
					<div class="x_content">
						...
						<form id="frmMenu" v-on:submit="guardardatos()"  data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="form-group row">
								...
								<div class="col-md-6 col-sm-6 ">
									<select id="distrito" v-model="distritoPadre" class="select2_single form-control" tabindex="-1" name="distrito">
	...
	methods: {
		async iniciarCarga() {
			...
			try{
				...
				console.log("listaDistrito:",this.listadistrito) 
			}catch(error){
		...
		guardardatos(){
			var data = { 
                ...
                distrito:this.distritoPadre
				};
				console.log("celar:",distrito)
			var metodo="POST";
		...
		editarProveedor(datos){
            ...
            console.log("d:",this.distritoPadre)
		},
		async eliminarProveedor(codigotmp){
			Swal.fire({
...
.then((result) => {
  ...
  if (result.isConfirmed) {
	fetch("http://localhost:8080/v1/proveedor/"+codigotmp,{
		method: "DELETE",
		headers:{
