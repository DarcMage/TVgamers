					...
					<div class="x_content">
						<div class="row">
							<div class="col-sm-12">
								...
								v-model="searchnombre" v-on:input="iniciarCarga();" required class="form-control" placeholder="Buscar por Fecha">
							</div>
                          <div class="col-sm-12">
					...
					<div class="x_content">
						...
						<form id="frmMenu" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align">Fecha Pedido <span class="required"></span>
											</label>
							...
							<div class="form-group row">
								<label class="control-label col-md-3 col-sm-3 label-align">Cliente </label>
								<div class="col-md-6 col-sm-6 ">
									<select v-model="menuPadre" class="select2_single form-control" tabindex="-1">
										<option>Sin Menu Padre</option>										
										<option v-for="itemMenu in listamenus" :value="itemMenu.codigo">{{ itemMenu.nombre }}</option>		
									</select>
								</div>
							</div>

                            <div class="form-group row">
								<label class="control-label col-md-3 col-sm-3 label-align">Farmaceutico </label>
								<div class="col-md-6 col-sm-6 ">
									<select v-model="menuPadre" class="select2_single form-control" tabindex="-1">
										<option>Sin Menu Padre</option>										
										<option v-for="itemMenu in listamenus" :value="itemMenu.codigo">{{ itemMenu.nombre }}</option>		
                            ...
                            <div class="form-group row">
								<label class="control-label col-md-3 col-sm-3 label-align">Tipo Pago </label>
								<div class="col-md-6 col-sm-6 ">
									<select v-model="menuPadre" class="select2_single form-control" tabindex="-1">
										<option>Sin Menu Padre</option>										
										<option v-for="itemMenu in listamenus" :value="itemMenu.codigo">{{ itemMenu.nombre }}</option>		
							...
							<div class="item form-group">
								<label for="orden" class="col-form-label col-md-3 col-sm-3 label-align">Total </label>
								<div class="col-md-6 col-sm-6 ">
